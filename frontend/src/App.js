              ...
              <ScrollToBottom className={ROOT_CSS}>
                {messages.map((m) => (
                  <div className="alert alert-secondary" key={m.id}>
                    {m.name} -{" "}
                    {m.type === "im" && <img src={m.message} alt=""/>}
        ...
        {selectedUser && (
          <div className="col-md-5">
            <div class="form-check">
              ...
              />
              <label class="form-check-label" htmlFor="exampleRadios11">
                Image
              </label>
            </div>
            <div class="form-check">
              ...
              />
              <label class="form-check-label" htmlFor="exampleRadios22">
                Text
              </label>
            </div>
                ...
                {selectedUser &&
                  ...
                  selectedUser.messages.map((msg, index) => (
                    <div key={index} className="alert alert-secondary">
                      ...
                      {" - "}
                      {/* {msg.message} */}
                      {msg.type === "im" && <img src={msg.message} alt=""/>}
